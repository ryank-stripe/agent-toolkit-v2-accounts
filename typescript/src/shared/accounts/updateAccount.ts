...
export const updateAccountParameters = (
  ...
  z.object({
    account_id: z.string().describe('The ID of the account to update'),
    display_name: z
      .string()
      .optional()
...
export const updateAccount = async (
  ...
  try {
    ...
    const accountData: Stripe.V2.Core.AccountUpdateParams = {
      ...otherParams,
    };
    ...
    if (
      ...
      accountData.defaults = {} as Stripe.V2.Core.AccountUpdateParams.Defaults;
    ...
    if (
      ...
      accountData.identity = {} as Stripe.V2.Core.AccountUpdateParams.Identity;
      ...
      if (
        ...
        accountData.identity.individual =
          {} as Stripe.V2.Core.AccountUpdateParams.Identity.Individual;
        ...
        if (
          ...
          accountData.identity.individual.address =
            {} as Stripe.V2.Core.AccountUpdateParams.Identity.Individual.Address;
      ...
      if (
        ...
        accountData.identity.business_details =
          {} as Stripe.V2.Core.AccountUpdateParams.Identity.BusinessDetails;
        ...
        if (
          ...
          accountData.identity.business_details.address =
            {} as Stripe.V2.Core.AccountUpdateParams.Identity.BusinessDetails.Address;
        ...
        if (idNumberType || idNumberValue) {
          accountData.identity.business_details.id_numbers =
            [] as Stripe.V2.Core.AccountUpdateParams.Identity.BusinessDetails.IdNumber[];
          const idNumber =
            {} as Stripe.V2.Core.AccountUpdateParams.Identity.BusinessDetails.IdNumber;
      ...
      if (
        ...
        if (
          ...
          accountData.configuration.merchant.branding =
            {} as Stripe.V2.Core.AccountUpdateParams.Configuration.Merchant.Branding;
        ...
        if (
          ...
          accountData.configuration.merchant.card_payments =
            {} as Stripe.V2.Core.AccountUpdateParams.Configuration.Merchant.CardPayments;
        ...
        if (
          ...
          accountData.configuration.merchant.statement_descriptor =
            {} as Stripe.V2.Core.AccountUpdateParams.Configuration.Merchant.StatementDescriptor;
        ...
        if (
          ...
          accountData.configuration.merchant.support =
            {} as Stripe.V2.Core.AccountUpdateParams.Configuration.Merchant.Support;
          ...
          if (
            ...
            accountData.configuration.merchant.support.address =
              {} as Stripe.V2.Core.AccountUpdateParams.Configuration.Merchant.Support.Address;
        ...
        if (configurationMerchantCardPaymentCapabilityRequested !== undefined) {
          accountData.configuration.merchant.capabilities =
            {} as Stripe.V2.Core.AccountUpdateParams.Configuration.Merchant.Capabilities;
      ...
      if (
        ...
        if (
          ...
          accountData.configuration.customer.automatic_indirect_tax =
            {} as Stripe.V2.Core.AccountUpdateParams.Configuration.Customer.AutomaticIndirectTax;
        ...
        if (
          ...
          accountData.configuration.customer.billing =
            {} as Stripe.V2.Core.AccountUpdateParams.Configuration.Customer.Billing;

          accountData.configuration.customer.billing.invoice =
            {} as Stripe.V2.Core.AccountUpdateParams.Configuration.Customer.Billing.Invoice;
        ...
        if (
          ...
          accountData.configuration.customer.shipping =
            {} as Stripe.V2.Core.AccountUpdateParams.Configuration.Customer.Shipping;
        ...
        if (
          ...
          accountData.configuration.customer.capabilities =
            {} as Stripe.V2.Core.AccountUpdateParams.Configuration.Customer.Capabilities;
      ...
      if (
        ...
        if (
          ...
          accountData.configuration.recipient.capabilities.bank_accounts =
            {} as Stripe.V2.Core.AccountUpdateParams.Configuration.Recipient.Capabilities.BankAccounts;
        ...
        if (
          ...
          accountData.configuration.recipient.capabilities.stripe_balance =
            {} as Stripe.V2.Core.AccountUpdateParams.Configuration.Recipient.Capabilities.StripeBalance;
...
const tool = (context: Context): Tool => ({
  ...
  annotations: updateAccountAnnotations(),
  actions: {
    accounts: {
      update: true,
    },
